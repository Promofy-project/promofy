...
insert into public.cupons
  ...
  ('c01', 'e1', 'Rodízio de pizza em dobro', 'alimentacao',
   '2 rodízios pelo preço de 1', 45, 89.9, 44.9, '2026-06-30', 1000,
  ...
  ('c02', 'e1', '20% off no almoço executivo', 'alimentacao',
   'Prato + bebida + sobremesa', 18, null, null, '2026-07-15', 1000,
  ...
  ('c03', 'e2', '1 mês grátis na matrícula', 'fitness',
   'Plano anual com 1 mês cortesia', 99, 199, 99, '2026-07-31', null,
  ...
  ('c04', 'e2', 'Aula de spinning 2x1', 'fitness',
   'Traga um amigo sem custo', 30, null, null, '2026-06-25', null,
  ...
  ('c05', 'e3', 'Corte + escova com 40% off', 'beleza',
   'Inclui hidratação expressa', 50, 125, 75, '2026-07-10', null,
  ...
  ('c06', 'e3', 'Dia de noiva com brinde', 'beleza',
   'Pacote completo + acompanhante', 120, null, null, '2026-08-20', null,
  ...
  ('c07', 'e4', 'Fone bluetooth com 35% off', 'eletronicos',
   'Modelos selecionados', 140, 399, 259, '2026-07-05', null,
  ...
  ('c08', 'e4', 'Película + capa grátis na compra', 'eletronicos',
   'Na compra de qualquer smartphone', 60, null, null, '2026-06-24', null,
  ...
  ('c09', 'e5', 'Curso de inglês — 3 meses grátis', 'educacao',
   'Plano semestral com 3 meses extra', 290, 580, 290, '2026-08-31', null,
  ...
  ('c10', 'e5', 'Mentoria de carreira 50% off', 'educacao',
   'Sessão individual de 1h', 75, 150, 75, '2026-07-20', null,
  ...
  ('c11', 'e6', 'Banho & tosa leve 2x1', 'pet',
   'Para cães de pequeno porte', 40, null, null, '2026-07-12', null,
  ...
  ('c12', 'e6', 'Ração premium 25% off', 'pet',
   'Sacos de 15kg selecionados', 55, 220, 165, '2026-07-28', null,
  ...
  ('p-campanha-esgotada', 'e1', 'Combo casal + 2 sobremesas', 'alimentacao',
   'Para 2 pessoas, no jantar', 60, null, null, '2026-08-10', 500,
  ...
  ('p-campanha-expirada', 'e1', 'Rodízio com 30% off (almoço)', 'alimentacao',
   'Almoço de segunda a sexta', 28, null, null, '2026-05-31', 800,
